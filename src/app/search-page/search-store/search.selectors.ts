...
export const selectAllSearches = createSelector(selectSearchesState, fromSearches.selectAll);
export const selectAllSearchEntities = createSelector(selectSearchesState, fromSearches.selectEntities);
