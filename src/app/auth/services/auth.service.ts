...
export class AuthService {
  ...
  private readonly REDIRECT_URL = 'https://julianm2-makes-great-sites.netlify.app/auth';
  private readonly SCOPES = `user-read-email user-read-private user-read-playback-state user-modify-playback-state user-read-currently-playing playlist-modify-private playlist-read-private playlist-read-collaborative playlist-modify-public user-library-modify user-library-read user-follow-read user-top-read user-follow-modify`;
